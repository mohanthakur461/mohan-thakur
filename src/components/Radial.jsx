...
const Radial = ({info}) => {
  return (
    <section className="overflow-hidden pt-sp-70">
        ...
        <p className='text-center'>Feel free to reach out for collaboration or opportunities. <br/>I’d love to connect!</p>
        <div className="radial-anim relative px-6 max-w-[900px] pt-[200px] mx-auto text-center bg-[radial-gradient(rgba(39,208,255,0.18)_20%,rgba(19,48,68,0.00)_67%)]">
